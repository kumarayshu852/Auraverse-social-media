        ...
        <div className="flex flex-col h-screen">
                            ...
                            <div key={index} className={`flex flex-col ${msg.to_user_id !== user._id ? 'items-start' : 'items-end'}`}>
                                <div className={`p-2 text-sm max-w-sm bg-white text-slate-700 rounded-lg shadow ${msg.to_user_id !== user._id ? 'rounded-bl-none' : 'rounded-br-none'}`}>
                                    {msg.message_type === 'image' &&
                                        <img src={msg.media_url} className="w-full max-w-sm rounded-lg" alt=""/>
                                    }
                                    <p>{msg.text}</p>
                                </div>
                            </div>
            ...
            <div className="px-4">
                ...
                max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
                    ...
                    to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:Scale-95 cursor-pointer text-white p-2 rounded-full">
